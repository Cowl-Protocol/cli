...
| 🟢 | Trade adapter | L-01 and L-02 **fixed, deployed, verified and reaching every client** as of 2026-08-02 — new adapter on both chains, CLI 0.6.15, both relayers, and the browser app. Testnet was proven by a real private trade before mainnet was touched, and the redeploy itself uncovered [R-07](relayer/README.md) | [static/](static/README.md) |
